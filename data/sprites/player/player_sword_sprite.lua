return function(spriteBank)
  ...
  sb:addTimedAction(3, alterHitbox(-8, -8 - 19, 10, 19))
  sb:buildSubstrip('up')
  -- #substrip down
  ...
  sb:addTimedAction(1, alterHitbox(-8 - 10, -8, 10, 16))
  ...
  sb:addTimedAction(1, alterHitbox(-8, -8 - 10, 16, 10))
  sb:addTimedAction(2, alterHitbox(-8 - 10, -8 - 10, 10, 16 + 6))
  sb:addTimedAction(3, alterHitbox(-8 - 19, 8 - 10, 19, 10))
  ...
  sb:addTimedAction(1, alterHitbox(-8, -8 - 10, 16, 10))
  sb:addTimedAction(2, alterHitbox(8, -8 - 10, 10, 16 + 6))
  sb:addTimedAction(3, alterHitbox(8, 8 - 10, 19, 10))

...
return function(spriteBank)
  ...
  -- #substrip up
  ab:addSpriteFrame(1, 1, 16, 0, nil, nil, 3)
  ab:addSpriteFrame(2, 1, 13, -13, nil, nil, 3)
  ab:addSpriteFrame(3, 1, -4, -20, nil, nil, 8)
  ab:addSpriteFrame(3, 1, -4, -12, nil, nil, 3)
  ...
  ab:buildSubstrip('up')
  -- #substrip down
  ab:addSpriteFrame(5, 1, -15, 2, nil, nil, 3)
  ab:addSpriteFrame(6, 1, -13, 15, nil, nil, 3)
  ab:addSpriteFrame(7, 1, 3, 20, nil, nil, 8)
  ab:addSpriteFrame(8, 2, 3, 14, nil, nil, 3)
  ...
  -- #substrip left
  ab:addSpriteFrame(3, 1, 0, -16, nil, nil, 3)
  ab:addSpriteFrame(4, 1, -13, -13, nil, nil, 3)
  ab:addSpriteFrame(5, 1, -20, 4, nil, nil, 8)
  ab:addSpriteFrame(5, 1, -12, 4, nil, nil, 3)
  ...
  ab:addSpriteFrame(3, 1, 0, -16, nil, nil, 3)
  ab:addSpriteFrame(2, 1, 13, -13, nil, nil, 3)
  ab:addSpriteFrame(1, 1, 20, 4, nil, nil, 8)
  ab:addSpriteFrame(1, 1, 12, 4, nil, nil, 3)
  ...
  ab:setLoopType('once')
  -- #substrip up
  ab:addSpriteFrame(3, 1, -4, -20, nil, nil, 6)
  ab:addTimedAction(1, alterHitbox(-8, -8 - 19, 10, 19))
  ab:buildSubstrip('up')
  -- #substrip down
  ab:addSpriteFrame(7, 1, 3, 20, nil, nil, 6)
  ab:addTimedAction(1, alterHitbox(8 - 10, 8, 10, 19))
  ab:buildSubstrip('down', true)
  -- #substrip left
  ab:addSpriteFrame(5, 1, -20, 4, nil, nil, 6)
  ab:addTimedAction(1, alterHitbox(-8 - 19, 8 - 10, 19, 10))
  ab:buildSubstrip('left')
  -- #substrip right
  ab:addSpriteFrame(1, 1, 20, 4, nil, nil, 6)
  ...
  -- #substrip up
  ab:addSpriteFrame(3, 1, -4, -20, nil, nil, 6)
  ab:addSpriteFrame(3, 1, -4, -12, nil, nil, 8)
  ab:buildSubstrip('up')
  -- #substrip down
  ab:addSpriteFrame(7, 1, 3, 20, nil, nil, 6)
  ab:addSpriteFrame(7, 1, 3, 14, nil, nil, 8)
  ab:buildSubstrip('down', true)
  -- #substrip left
  ab:addSpriteFrame(5, 1, -20, 4, nil, nil, 6)
  ab:addSpriteFrame(5, 1, -14, 4, nil, nil, 8)
  ab:buildSubstrip('left')
  -- #substrip right
  ab:addSpriteFrame(1, 1, 20, 4, nil, nil, 6)
  ab:addSpriteFrame(1, 1, 12, 4, nil, nil, 8)
  ab:buildSubstrip('right')
  -- BUILD stab
  ...
  ab:setLoopType('once')
  -- #substrip up
  ab:addSpriteFrame(3, 1, -4, -19, nil, nil, 3)
  ab:addSpriteFrame(2, 1, 16, -16, nil, nil, 2)
  ab:addSpriteFrame(1, 1, 19, 4, nil, nil, 3)

  ab:addSpriteFrame(8, 1, 16, 16, nil, nil, 2)
  ab:addSpriteFrame(7, 1, 3, 19, nil, nil, 3)
  ab:addSpriteFrame(6, 1, -13, 15, nil, nil, 2)

  ab:addSpriteFrame(5, 1, -19, 4, nil, nil, 3)
  ab:addSpriteFrame(4, 1, -13, -13, nil, nil, 2)
  ab:addSpriteFrame(3, 1, -4, -19, nil, nil, 3)

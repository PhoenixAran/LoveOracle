...
return function(spriteBank)
  ...
  spriteBuilder:setSpriteSheet('inventory_cursors')
  spriteBuilder:addCompositeSprite(spriteBuilder:buildSprite(3, 1, -6, 0, 0, 0))
  spriteBuilder:addCompositeSprite(spriteBuilder:buildSprite(4, 1, 10, 0, 0, 0))
  spriteBank.registerSprite('inventory_cursor_green', spriteBuilder:buildCompositeSprite())

...
return function(spriteBank)
  ...
  spriteBank.registerSprite('pc_y_button', spriteBuilder:buildSprite(1, 1, 0, 0, 0, 1))

  -- xbox
  spriteBank.registerSprite('xbox_b_button', spriteBuilder:buildSprite(3, 1, 0, 0, 0, 1))
  spriteBank.registerSprite('xbox_x_button', spriteBuilder:buildSprite(5, 1, 0, 0, 0, 1))
  spriteBank.registerSprite('xbox_y_button', spriteBuilder:buildSprite(4, 1, 0, 0, 0, 1))

  -- playstation
  spriteBank.registerSprite('playstation_b_button', spriteBuilder:buildSprite(6, 1, 0, 0, 0, 1))
  spriteBank.registerSprite('playstation_x_button', spriteBuilder:buildSprite(8, 1, 0, 0, 0, 1))
  spriteBank.registerSprite('playstation_y_button', spriteBuilder:buildSprite(7, 1, 0, 0, 0, 1))

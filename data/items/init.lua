...
swordData:setName('sword')
swordData:setDescription('L-1 Sword', 1)
swordData:setGroup('slot_item')
...
shieldData:setName('shield')
shieldData:setDescription('L-1 Shield')
shieldData:setGroup('equipment')
...
boomerang:setDescription('L-1 Boomerang')
boomerang:setGroup('slot_item')
